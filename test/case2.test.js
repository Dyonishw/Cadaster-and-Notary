...
contract('CadasterDatabase', function (accounts) {
    ...
    beforeEach(async function () {
     ...
     it('should test for agreementForVoid to pass', async function () {
      ...
      await expectThrow(notar.agreementForVoid({from: externalAddress}));
      await notar.agreementForVoid({from: firstLandlord});
      await notar.agreementForVoid({from: buyerAddress});
